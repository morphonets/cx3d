...
package sc.iview.cx3d.spatialOrganization;

import static sc.iview.cx3d.utilities.Matrix.*;
import sc.iview.cx3d.parallelSpatialOrganization.SimpleAssignmentPolicy;
import sc.iview.cx3d.parallelSpatialOrganization.SpatialOrganizationManager;
...
//	}
	...
	public int runSingleTest(long seed, int printAt, LinkedList<Integer> checkAt) {
		...
		SpaceNode.clear();
		Tetrahedron.clear();
		sc.iview.cx3d.parallelSpatialOrganization.SpaceNode.clear();
		sc.iview.cx3d.parallelSpatialOrganization.Tetrahedron.clear();
...
//				startTetrahedron = innerNodes[i].insert(startTetrahedron);
				...
				if (sc.iview.cx3d.parallelSpatialOrganization.SpaceNode.allNodes != null)
					sc.iview.cx3d.parallelSpatialOrganization.SpaceNode.allNodes.remove(innerNodes[i]);
				i--;
			}
		}
