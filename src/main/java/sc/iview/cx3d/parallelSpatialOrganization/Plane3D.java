 ...
 */
public class Plane3D<T> extends ManagedObject<T> {
	 ...
	 * @param origObj
	 */
	Plane3D(Plane3D<T> origObj) {
		this.tracker = null;
		if (origObj.normalVector != null)
			this.normalVector = origObj.normalVector.clone();
		else
			this.normalVector = null;
		this.offset = origObj.offset;
		this.tolerance = origObj.tolerance;
		this.normalVectorUpdated = origObj.normalVectorUpdated;
	 ...
	 */
	public Plane3D(Tetrahedron<T> tetra, SpaceNode<T> nonUsedNode) throws NodeLockedException, ManagedObjectDoesNotExistException {
...
//	}
	 ...
	 * @throws NodeLockedException 
	 */
	protected int orientationExact(double[] point1, double[] point2) throws NodeLockedException, ManagedObjectDoesNotExistException {
	 ...
	 * @throws NodeLockedException 
	 */
	public int orientation(double[]point1, double[] point2) throws NodeLockedException, ManagedObjectDoesNotExistException {
	 ...
	 * @throws NodeLockedException 
	 */
	public boolean trulyOnSameSide(double[] point1, double[] point2) throws NodeLockedException, ManagedObjectDoesNotExistException {
	 ...
	 * @throws NodeLockedException 
	 */
	public boolean trulyOnDifferentSides(double[] point1, double[] point2) throws NodeLockedException, ManagedObjectDoesNotExistException {
		return orientation(point1, point2) < 0;
	}
	 ...
	 * @throws NodeLockedException 
	 */
	public boolean onSameSide(double[] point1, double[] point2) throws NodeLockedException, ManagedObjectDoesNotExistException {
		return orientation(point1, point2) >= 0;
	}
	 ...
	 */
	public ManagedObject<T> getLocalCopy() throws NodeLockedException,
