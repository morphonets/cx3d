...
import sc.iview.cx3d.synapses.BiologicalSomaticSpine;
import sc.iview.cx3d.synapses.PhysicalSomaticSpine;
...
//		double theta = 6.28318531*ecm.getRandomDouble();
	 ...
	 * @param p to make a spine and maximal nr of spines allowed on soma.
	 */
